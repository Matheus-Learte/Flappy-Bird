...
#Classe que define a mensagem de quando inicia o jogo e herda as funções da classe de Sprite.Group() do pygame
class Start(pygame.sprite.Sprite):
    #Função construtora
    def __init__(self, *groups):
        self._layer=Layer.UI #Seta a profundidade
        self.image=assets.get_sprite("message") #Guarda o sprite "message" no self.image
